              ...
              <div className="hl_navbar--collapse" id="navbar-collapse">
                ...
                <ul className="hl_navbar--links list-unstyled" id="nav-links">
                  ...
                  <li id="nav-marketing">
                    ...
                    <div className="collapse nav-dropdown-links" id="nav-marketing-collapse">
                      <ul>
                        <li className="active">
                  ...
                  <li id="nav-customers">
                    ...
                    <div className="collapse nav-dropdown-links" id="nav-customer-collapse">
                      <ul>
                        <li className="active">
                  ...
                  <li id="nav-online-analysis">
                    <a href="./online-analysis.html" data-tooltip="nav-tooltip" data-placement="right" title="Online Analysis">
